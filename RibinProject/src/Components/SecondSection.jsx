    ...
    return (
        <Stack sx={{ paddingX: '5%', paddingY: '2%', mt: '5rem' }}>
            <Stack direction={{ xs: 'column', md: 'row' }} justifyContent='space-between' alignItems='stretch' rowGap={5}>
                ...
                {
                    box === 1 ?
                        <Box sx={{ width: { xs: '100%', md: '52%' },textAlign: 'center', display: 'flex', flexDirection: 'column', alignItems: 'center', bgcolor: '#EBCCFF59', paddingX: '8%', paddingY: { xs: '14%', md: '2%' }, borderRadius: { xs: '60px', md: '88px' }, position: 'relative', height: '400px', rowGap: '10px' }}>
                        ...
                        box === 2 ?
                            <Box sx={{ width: { xs: '100%', md: '52%' },textAlign: 'center', display: 'flex', flexDirection: 'column', alignItems: 'center', bgcolor: '#B2279C59', paddingX: '8', paddingY: { xs: '14%', md: '2%' }, borderRadius: { xs: '60px', md: '88px' }, position: 'relative', height: '400px', rowGap: '10px' }}>
                                ...
                                <Image src={Phone2} alt='phone' sx={{ width: { xs: '40%', md: '22%' }, position: 'absolute', bottom: '0px' }} />
                            </Box> : box === 3 ?
                                <Box sx={{ width: { xs: '100%', md: '52%' },textAlign: 'center', display: 'flex', flexDirection: 'column', alignItems: 'center', bgcolor: '#F24CBA59', pad8ngX: '10%', paddingY: { xs: '14%', md: '2%' }, borderRadius: { xs: '60px', md: '88px' }, position: 'relative', height: '400px', rowGap: '10px' }}>
